...
**Overall: 56.4%** (CI threshold: 50%)

### Controllers

| Class | Coverage | Notes |
|-------|----------|-------|
| CampaignController | 74.9% | Campaign CRUD, check claims, refund, QR download |
| CodeController | 17.2% | Claim logic heavily branched; needs more test paths |
| PhyrhoseProxyController | 100.0% | All 5 proxy endpoints covered |
| ProfileController | 70.4% | Profile CRUD, token management |
...
|------|---------|--------|-------|
| PHP overall coverage | 56.4% | 70% | [#7](https://github.com/cardano-onboard/platform/issues/7) |
| CodeController coverage | 17.2% | 60%+ | [#7](https://github.com/cardano-onboard/platform/issues/7) |
