...
# Now run the post-install scripts with artisan available
...
# Vite needs vendor/tightenco/ziggy on disk to resolve the Ziggy import in
# resources/js/app.js — pull it from the composer stage before building.
