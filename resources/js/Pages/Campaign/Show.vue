...
const needed_tokens_table = reactive({
    headers: [
        ...
        {title: 'Name', align: 'start', key: 'asset_name', value: item => self.hexToString(item.asset_id)},
            ...
            <v-row justify="center">
                <v-col cols="12" md="10" lg="9" xl="7">
                    ...
                    <v-toolbar color="transparent">
                        ...
                        <v-btn color="info" :href="route('campaigns.download-qr', campaign.id)"
                               v-if="campaign.codes && campaign.codes.length > 0">
                            <v-icon icon="mdi-qrcode"></v-icon>
                            Download QR
                        </v-btn>
                        <v-btn color="success" @click="dialog.wallet = true"
